...
/**
 * Adapted from https://github.com/Operational-Transformation/ot.js/blob/master/lib/codemirror-adapter.js
 */
export class CodeMirrorAdapter {

    private ignoreNextChange: boolean;
    private changeInProgress: boolean;
    ...
    // private operationFromCodeMirrorChanges = function (changes: CodeMirror.EditorChangeLinkedList[], instance: CodeMirror.Editor) {
...
// function codemirrorDocLength(doc: CodeMirror.Editor) {
//     return doc.indexFromPos({ line: doc.lastLine(), ch: 0 }) +
//         doc.getLine(doc.lastLine()).length;
// }

function last(arr: Array<any>) { return arr[arr.length - 1]; }
